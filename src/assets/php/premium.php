<?php
    if (!function_exists('premium_aktiv')) {
    ...
    if (!function_exists('user_premium')) {
    ...
    if(!function_exists('premium_badge_add')) {
    ...
    if(!function_exists('premium_aktivalas_30nap')) {
    ...
    if(!function_exists('premium_datum')) {
