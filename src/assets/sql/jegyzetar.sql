...
(1, 4, 'Java zero to hero', 'JavaNotesForProfessionals.pdf', 'asd', 'C:xampphtdocsjegyzetar.eu-srcsrc/users/csontoskincso05/JavaNotesForProfessionals.pdf', 'Informatika', 'Tankönyv', NULL);
...
(1, 'Csontos', 'Kincső', 'doomhyena', '2005-04-04', NULL, 'csontoskincso@doomhyena.hu', 'christmaspfp.png', '', 'Mi volt az első háziállatod neve?', 'Gréti', 1, '2025-12-01 19:15:49', 'hu', 'discord', '864583234158460938', 1, '', 'light'),
(4, 'Csontos', 'Kincső', 'csontoskincso05', '2005-04-04', 'female', 'csontoskincso05@gmail.com', '2967dd50051e1218d6a16b711cfdf0da.jpg', '$2y$10$ZLWnsc4oApKzTPcMkkeC8OcVEmKA3PVyV2Fu7Mn4cCKTrQR5wmLgK', 'Mi a kedvenc könyved?', 'Harry Potter', 1, '2025-12-02 08:52:05', 'hu', NULL, NULL, 0, NULL, 'default');
