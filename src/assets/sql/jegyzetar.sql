...
(3319, 'nav_news', 'hu', 'Hírek'),
(3320, 'nav_news', 'en', 'News'),
(3321, 'nav_news', 'de', 'Nachrichten'),
(3322, 'upload_err_profanity', 'hu', 'Ne használj trágár szavakat jegyzet feltöltésnél!'),
(3323, 'upload_err_profanity', 'en', 'Please do not use profanity when uploading notes!'),
(3324, 'upload_err_profanity', 'de', 'Bitte verwende keine Schimpfwörter beim Hochladen von Notizen!'),
(3325, 'upload_err_required_fields', 'hu', 'Kérlek tölts ki minden kötelező mezőt (név, leírás).'),
(3326, 'upload_err_required_fields', 'en', 'Please fill in all required fields (name, description).'),
(3327, 'upload_err_required_fields', 'de', 'Bitte fülle alle Pflichtfelder aus (Name, Beschreibung).'),
(3328, 'upload_err_missing_markdown_migration', 'hu', 'A jegyzet feltöltéshez hiányzik az adatbázis frissítés (content_type / note_markdown).'),
(3329, 'upload_err_missing_markdown_migration', 'en', 'Database update missing for note uploads (content_type / note_markdown).'),
(3330, 'upload_err_missing_markdown_migration', 'de', 'Datenbank-Update für Notiz-Uploads fehlt (content_type / note_markdown).'),
(3331, 'upload_err_markdown_empty', 'hu', 'A Markdown jegyzet nem lehet üres.'),
(3332, 'upload_err_markdown_empty', 'en', 'Markdown note cannot be empty.'),
(3333, 'upload_err_markdown_empty', 'de', 'Markdown-Notiz darf nicht leer sein.'),
(3334, 'upload_err_markdown_too_large_fmt', 'hu', 'A Markdown jegyzet maximum %d MB lehet.'),
(3335, 'upload_err_markdown_too_large_fmt', 'en', 'Markdown note can be at most %d MB.'),
(3336, 'upload_err_markdown_too_large_fmt', 'de', 'Markdown-Notiz darf maximal %d MB groß sein.'),
(3337, 'upload_err_file_type_not_allowed', 'hu', 'Ez a fájltípus nem engedélyezett. Csak PDF, MP4 és DOCX tölthető fel.'),
(3338, 'upload_err_file_type_not_allowed', 'en', 'This file type is not allowed. Only PDF, MP4 and DOCX may be uploaded.'),
(3339, 'upload_err_file_type_not_allowed', 'de', 'Dieser Dateityp ist nicht erlaubt. Es dürfen nur PDF, MP4 und DOCX hochgeladen werden.'),
...
(3352, 'groups_create_button', 'hu', 'Új csoport létrehozása'),
(3353, 'groups_create_button', 'en', 'Create new group'),
(3354, 'groups_create_button', 'de', 'Neue Gruppe erstellen'),
...
(3619, 'exam_sw_subtitle', 'de', 'Überblick über die Branchen-Grundprüfung und die Fachprüfung sowie deren Bewertungs- und Beurteilungskriterien.'),
(3620, 'exams_title', 'hu', 'Vizsgák'),
(3621, 'exams_title', 'en', 'Exams'),
(3622, 'exams_title', 'de', 'Prüfungen'),
(3623, 'exams_intro', 'hu', 'Itt találod röviden és érthetően, hogyan zajlanak a vizsgák.'),
(3624, 'exams_intro', 'en', 'Find a short and clear overview of how the exams work.'),
(3625, 'exams_intro', 'de', 'Hier findest du eine kurze und klare Übersicht darüber, wie die Prüfungen ablaufen.'),
(3626, 'exam_card_sw_title', 'hu', 'Szoftverfejlesztő vizsga'),
(3627, 'exam_card_sw_title', 'en', 'Software developer exam'),
(3628, 'exam_card_sw_title', 'de', 'Softwareentwickler-Prüfung'),
(3629, 'exam_card_sw_description', 'hu', 'Felépítés, menetrend, mire figyelj, tippek.'),
(3630, 'exam_card_sw_description', 'en', 'Structure, schedule, what to watch for, tips.'),
(3631, 'exam_card_sw_description', 'de', 'Aufbau, Ablauf, worauf du achten solltest, Tipps.'),
(3632, 'exam_card_sys_title', 'hu', 'Rendszerüzemeltető vizsga'),
(3633, 'exam_card_sys_title', 'en', 'System administrator exam'),
(3634, 'exam_card_sys_title', 'de', 'Systemadministrator-Prüfung'),
(3635, 'exam_card_sys_description', 'hu', 'Felépítés, menetrend, tipikus feladatok, tippek.'),
(3636, 'exam_card_sys_description', 'en', 'Structure, schedule, typical tasks, tips.'),
(3637, 'exam_card_sys_description', 'de', 'Aufbau, Ablauf, typische Aufgaben, Tipps.'),
(3638, 'btn_open_exam', 'hu', 'Megnyitás'),
(3639, 'btn_open_exam', 'en', 'Open'),
(3640, 'btn_open_exam', 'de', 'Öffnen'),
(3641, 'btn_back_to_exams', 'hu', 'Vissza a vizsgákhoz'),
(3642, 'btn_back_to_exams', 'en', 'Back to exams'),
(3643, 'btn_back_to_exams', 'de', 'Zurück zu den Prüfungen'),
...
(3890, 'upload_help_video_link', 'hu', 'Illeszd be a videó linkjét (YouTube, vagy bármilyen https:// URL). A videó beágyazva fog megjelenni a note oldalán.'),
(3891, 'upload_help_video_link', 'en', 'Enter the video link (YouTube, or any https:// URL). The video will be embedded on the note page.'),
(3892, 'upload_help_video_link', 'de', 'Füge den Link zum Video ein (YouTube oder eine beliebige https://-URL). Das Video wird dann auf der Notizseite eingebettet angezeigt.'),
(3893, 'upload_invalid_link', 'hu', 'Érvényes linket kell megadni.'),
(3894, 'upload_invalid_link', 'en', 'A valid link is required.'),
(3895, 'upload_invalid_link', 'de', 'Ein gültiger Link ist erforderlich.'),
(3896, 'label_show_fullname', 'hu', 'Teljes név látható'),
(3897, 'label_show_fullname', 'en', 'Show full name'),
(3898, 'label_show_fullname', 'de', 'Vollständigen Namen anzeigen'),
(3899, 'label_show_email', 'hu', 'Email látható'),
(3900, 'label_show_email', 'en', 'Show email'),
(3901, 'label_show_email', 'de', 'E-Mail anzeigen'),
(3902, 'label_show_birthdate', 'hu', 'Születési dátum látható'),
(3903, 'label_show_birthdate', 'en', 'Show birthdate'),
(3904, 'label_show_birthdate', 'de', 'Geburtsdatum anzeigen'),
(3905, 'label_2fa', 'hu', 'Kétlépcsős azonosítás (2FA)'),
(3906, 'label_2fa', 'en', 'Two-factor authentication (2FA)'),
(3907, 'label_2fa', 'de', 'Zwei-Faktor-Authentifizierung (2FA)'),
(3908, 'label_2fa_status', 'hu', 'Állapot'),
(3909, 'label_2fa_status', 'en', 'Status'),
(3910, 'label_2fa_status', 'de', 'Status'),
(3911, '2fa_enabled', 'hu', 'Engedélyezve'),
(3912, '2fa_enabled', 'en', 'Enabled'),
(3913, '2fa_enabled', 'de', 'Aktiviert'),
(3914, '2fa_disabled', 'hu', 'Letiltva'),
(3915, '2fa_disabled', 'en', 'Disabled'),
