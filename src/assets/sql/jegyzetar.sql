...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 09, 2026 at 07:58 PM
...
INSERT INTO `translations` (`id`, `t_key`, `lang_code`, `text`) VALUES
    ...
    (1197, 'error_bio_too_long', 'hu', 'A bemutatkozás nem lehet hosszabb 1500 karakternél.'),
    (1198, 'error_bio_too_long', 'en', 'The bio cannot be longer than 1500 characters.'),
    (1199, 'error_bio_too_long', 'de', 'Die Biografie darf nicht länger als 1500 Z')
...
(9, 'ceci', 'ceci', 'ceci', '2026-01-07', 'male', 'baranyinorbert13@gmail.com', NULL, '$2a$12$1wh15urCj3FxDHzTNhitPOM4b048ZlUUjNSZJsi79RwVK25PUXDm6', 'ceci', 'ceci', 0, NULL, 'hu', NULL, NULL, 1, NULL, 'default');
